...
/// </remarks>
public class UiInt3 : UiFieldBase
{
    /// <summary>
    ...
    /// </summary>
    public override Type ViewType => typeof(UiInt3View);
    ...
    public UiInt3(string cliName, string label, int min = -(1 << 30), int max = 1 << 30, int stepSize = 1, string helpText = "", bool isAdvanced = false)
