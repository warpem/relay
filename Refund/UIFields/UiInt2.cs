...
/// </remarks>
public class UiInt2 : UiFieldBase
{
    /// <summary>
    ...
    /// </summary>
    public override Type ViewType => typeof(UiInt2View);
    ...
    public UiInt2(string cliName, string label, int min = -(1 << 30), int max = 1 << 30, int stepSize = 1, string helpText = "", bool isAdvanced = false)
