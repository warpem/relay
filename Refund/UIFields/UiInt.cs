...
public class UiInt : UiFieldBase
{
    ...
    /// </summary>
    public override Type ViewType => typeof(UiIntView);
    ...
    /// </remarks>
    public UiInt(string cliName, string label, int min = int.MinValue, int max = int.MaxValue, int stepSize = 1, string unit = "", string helpText = "", bool isAdvanced = false)
