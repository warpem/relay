...
public partial class AlignMissExpandedView : IAsyncDisposable
{
    #region Dependencies
    ...
    [Inject] private ILogger<AlignMissExpandedView> Logger { get; set; }
    ...
    private ReadOnlyAlignMiss _job;
    ...
    {
        if (job is ReadOnlyAlignMiss importDataSetTs)
        {
            ...
            _micrographs = _job.PortsIn[AlignMiss.PortInTiltSeriesSet]
                               .GetSingleResource<TiltSeriesSet>()
                               .DataSet
                               .Micrographs;
    ...
    private async Task SelectTsItem(int index, bool scrollToItem)
    {
        ...
        var tsSet = (TiltSeriesSet)_job.PortsOut[AlignMiss.PortOutTiltSeriesSet].GetResource();
