...
public partial class ReconstructTomogramsExpandedView : IAsyncDisposable
{
    #region Dependencies
    ...
    [Inject] private ILogger<ReconstructTomogramsExpandedView> Logger { get; set; }
    ...
    private ReadOnlyReconstructTomograms _job;
    ...
    {
        if (job is ReadOnlyReconstructTomograms reconstruct)
        {
            _job = reconstruct;
            _processedTomograms = [];
            ...
            _tomogramSet = _job.PortsOut[ReconstructTomograms.PortOutTomogramSet].GetResource(0) as TomogramSet;
